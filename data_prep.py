...
parser.add_argument('--output_data_dir', type=str, required=False, default='eval_data', help='Output data directory path.')

args = parser.parse_args()

scp_entries = open(f"./sample_data/audio_paths", 'r').readlines()
txt_entries = open(f"./sample_data/text", 'r').readlines()
...
if len(scp_entries) == len(txt_entries):
    ...
    audio_dataset.save_to_disk("./eval_data")
